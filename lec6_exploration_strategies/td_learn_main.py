import gym
from td_agents_exploration_strategies import SarsaAgent, QLAgent
...
def main(algorithm, num_episodes, gamma, alpha, epsilon):
    ...
    if algorithm == "Sarsa":
        agent = SarsaAgent(num_states, num_actions, alpha, gamma, epsilon, "UCB")
    elif algorithm == "QLearning":
        agent = QLAgent(num_states, num_actions, alpha, gamma, epsilon, "UCB")
    else:
