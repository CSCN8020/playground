...
def train(model, ckpt = "", seed=42, max_steps_per_episode=10000, model_ckpt_name="", visualize_training=False):
    ...
    if ckpt != "":
        model.load_weights("model_cartpole.ckpt")
